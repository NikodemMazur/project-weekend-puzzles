...
namespace ProjectWeekendPuzzles.Core.Prism
{
    ...
    public class ItemsControlRegionAdapter : RegionAdapterBase<ItemsControl>
    {
        ...
        protected override void Adapt(IRegion region, ItemsControl regionTarget)
        {
            ...
            var hasBinding = BindingOperations.GetBinding(regionTarget, ItemsControl.ItemsSourceProperty) != null;
            itemsSourceIsSet = itemsSourceIsSet || hasBinding;
        ...
        protected override IRegion CreateRegion()
        {
            ...
            return new AllActiveRegion(coreRegion);
        }
    }
}